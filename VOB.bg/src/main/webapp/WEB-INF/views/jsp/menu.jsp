      ...
      <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
			<div class="top-search">
				<form class="navbar-form navbar-right" action="/VOB.bg/search" id="type" >
				<div style="margin-left: -7em; position: relative; left: 220px;">
				<img src="images/logotext2.png"></div>
				<div>
				
			<input style="width: 350px;" id="text" onkeyup="search()" class="form-control" type="text" placeholder="Search.." name="text">
    	<div style="position: relative; bottom: 55px;left: 550px;width:100px;" name="type" form="type" class="custom-select">
