	...
	<div class="login-box" style="height: 300px;position: relative;top: 100px;">
	    ...
	    <form class="email-login" action="register" method="post">
	      <div class="u-form-group">
	      	<p>To complete your registration, place enter the code from the e-mail that we send you: </p>
	        <input type="text" name="inputCode" placeholder="Enter the code here ..." required />
	      </div>
	      <div class="u-form-group">
