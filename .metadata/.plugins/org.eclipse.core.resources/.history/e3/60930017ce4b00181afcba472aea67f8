...
public class UserManager {
	...
	public synchronized void addVideo(User u, String name, String description) throws InvalidUserDataException {
		Video v = VideoDao.getInstance().uploadVideo(u, name, description);
	}
